...
from proxy_inference_engine.models.base import (
    BaseModelArgs,
    create_attention_mask,
    scaled_dot_product_attention,
)
from proxy_inference_engine.models.llama.utils import Llama3RoPE
...
class Attention(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        rope_factor = args.rope_scaling.get("factor", 1.0)
        rope_low_freq_factor = args.rope_scaling.get("low_freq_factor", 1.0)
        rope_high_freq_factor = args.rope_scaling.get("high_freq_factor", 1.0)

        self.rope = Llama3RoPE(
            max_embedding_length=max_embedding_length,
            global_embedding_length=max_embedding_length,
            dimensions=self.head_dim,
            base=args.rope_theta,
            traditional=args.rope_traditional,
            factor=float(rope_factor),
            low_freq_factor=float(rope_low_freq_factor),
            high_freq_factor=float(rope_high_freq_factor),
        )
